...
const RegisterForm = () => {
    ...
    useEffect(() => {
        ...
        if(hightSchool){
            ...
            setCourseOptions([{ id: '0', name: 'Seleccione un curso' }, ...hightSchoolResponse.data ]);
        }
    }
    fetchOptions_();
    ...
    useEffect(() => {
        const fetchOptions = async () => {
            try {
                ...
                setRoleOptions([{ id: '0', name: 'Seleccione un tipo' }, ...roleResponse.data ]);
                setHightSchoolOptions([{ id: '0', name: 'Seleccione una institución' }, ...hightSchoolResponse.data]);
